...
export default function TaskCard(props) {
    return(
        <div className='p-5 border shadow-lg rounded-lg hover:bg-sky-100 cursor-pointer w-full select-none'>
            {/* Title and status */}
            <div className='mb-3 flex items-center justify-between'>
                <h3 className='text-2xl font-bold text-gray-700'>{props.title}</h3>
                <div className='flex flex-col items-center justify-center'>
                    <EllipsisHorizontalIcon className='w-7 text-gray-700 hover:text-sky-500' />
                </div>
            </div>
